...
for i_row in item_rows:
	...
	observations = []
	observations1 = Observation.objects.raw(execute_string)
	for o in observations1:
	...
	if(len(observations) > 0):
		...
		for obs_i in observations:
			...
			observedcharacteristics1 = ObservedCharacteristic.objects.raw(execute_string2)
			for oc in observedcharacteristics1:
				observedcharacteristics.append(oc)
			...
			for obs_char in observedcharacteristics:
				...
				#==========================================
				characteristic_i = []
				characteristic_i1 = Characteristic.objects.raw(execute_string3)
				for ch in characteristic_i1:
					print ch
					characteristic_i.append(ch)
